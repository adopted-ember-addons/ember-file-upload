/*! For license information please see chunk.916.c2968a56ac5ce5f6f05e.js.LICENSE.txt */
...
return n.pop(),a}return"string"===s?i:"[ERROR: Missing QUnit.dump formatter for type "+t+"]"},typeOf:function(e){var t
...
function H(e,t,n){var r=F.length?F.slice(-1)[0]:null,i=null!==r?[r.name,e].join(" > "):e,s=r?r.suiteReport:He,o=null!==r&&r.skip||n.skip,a=null!==r&&r.todo||n.todo,u={name:i,parentModule:r,tests:[],moduleId:O(i),testsRun:0,testsIgnored:0,childModules:[],suiteReport:new B(e,s),skip:o,todo:!o&&a,ignored:n.ignored||!1},l={}
...
function $(e,t,n){var r,i=Q&&(r=L.modules.filter((function(e){return!e.ignored})).map((function(e){return e.moduleId})),!F.some((function(e){return r.includes(e.moduleId)})))
U(e,t,n,{ignored:i})}$.only=function(){Q||(L.modules.length=0,L.queue.length=0),U.apply(void 0,arguments),Q=!0},$.skip=function(e,t,n){Q||U(e,t,n,{skip:!0})},$.todo=function(e,t,n){Q||U(e,t,n,{todo:!0})}
...
throw new Error("No tests were run.")}Y("runEnd",He.end(!0)),Z("done",{passed:n,failed:L.stats.bad,total:L.stats.all,runtime:t}).then((function(){if(e&&0===L.stats.bad)for(var t=e.length-1;t>=0;t--){var n=e.key(t)
...
L.pollution.push(e)}}ue.count=0,ue.prototype={get stack(){return X(this.errorForStack,2)},before:function(){var e=this,t=this.module,n=function(e){for(var t=e,n=[];t&&0===t.testsRun;)n.push(t),t=t.parentModule
return n.reverse()}(t)
return n.reduce((function(e,t){return e.then((function(){return t.stats={all:0,bad:0,started:C()},Y("suiteStart",t.suiteReport.start(!0)),Z("moduleStart",{name:t.name,tests:t.tests})}))}),V.resolve([])).then((function(){return L.current=e,e.testEnvironment=I({},t.testEnvironment),e.started=C(),Y("testStart",e.testReport.start(!0)),Z("testStart",{name:e.testName,module:t.name,testId:e.testId,previousFailure:e.previousFailure}).then((function(){L.pollution||ce()}))}))},run:function(){if(L.current=this,this.callbackStarted=C(),L.notrycatch)e(this)
...
break
default:t=e}return t}var Pe=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
n+="\n  message: ".concat(Le(e.message||"failed")),n+="\n  severity: ".concat(Le(t||"failed")),Ae.call(e,"actual")&&(n+="\n  actual  : ".concat(Le(e.actual))),Ae.call(e,"expected")&&(n+="\n  expected: ".concat(Le(e.expected))),e.stack&&(n+="\n  stack: ".concat(Le(e.stack+"\n"))),n+="\n  ...",this.log(n)}}],[{key:"init",value:function(t,n){return new e(t,n)}}]),e}(),Be={console:qe,tap:Pe},Fe={},He=new B
L.currentModule.suiteReport=He
var Ue=!1,Qe=!1
function $e(){Qe=!0,v?v((function(){ze()})):ze()}function Ge(){L.blocking=!1,oe.advance()}function ze(){if(L.started)Ge()
...
Y("runStart",He.start(!0)),Z("begin",{totalTests:ue.count,modules:t}).then(Ge)}}Fe.isLocal=p&&p.location&&"file:"===p.location.protocol,Fe.version="2.16.0",I(Fe,{config:L,dump:P,equiv:A,reporters:Be,is:R,objectType:_,on:function(e,t){if("string"!==_(e))throw new TypeError("eventName must be a string when registering a listener")
...
var t=Ue
if(Ue=!0,Qe)throw new Error("Called start() while test already started running")
...
$e()},extend:function(){x.warn("QUnit.extend is deprecated and will be removed in QUnit 3.0. Please use Object.assign instead.")
for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
return I.apply(this,t)},load:function(){L.pageLoaded=!0,I(L,{stats:{all:0,bad:0,testCount:0},started:0,updateRate:1e3,autostart:!0,filter:""},!0),Qe||(L.blocking=!1,L.autostart&&$e())},stack:function(e){return ee(e=(e||0)+2)}}),function(e){var t=["begin","done","log","testStart","testDone","moduleStart","moduleDone"]
...
"undefined"===_(L.callbacks[s])&&(L.callbacks[s]=[]),e[s]=n(s)}}(Fe),function(i){var s=!1
...
var We=Ye.exports,Je={passedTests:0,failedTests:0,skippedTests:0,todoTests:0}
function Ve(e){return e?(e+="").replace(/['"<>&]/g,(function(e){switch(e){case"'":return"&#039;"
case'"':return"&quot;"
case"<":return"&lt;"
case">":return"&gt;"
case"&":return"&amp;"}})):""}!function(){if(p&&y){var e=Fe.config,t=[],n=!1,r=Object.prototype.hasOwnProperty,i=N({filter:void 0,module:void 0,moduleId:void 0,testId:void 0})
Fe.begin((function(){var t,n,s,o,a,u,f,h,m,C,N;(u=w("qunit"))&&(u.setAttribute("role","main"),u.innerHTML="<h1 id='qunit-header'>"+Ve(y.title)+"</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar' role='navigation'></div>"+(!(t=Fe.config.testId)||t.length<=0?"":"<div id='qunit-filteredTest'>Rerunning selected tests: "+Ve(t.join(", "))+" <a id='qunit-clearFilter' href='"+Ve(i)+"'>Run all tests</a></div>")+"<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"),(n=w("qunit-header"))&&(n.innerHTML="<a href='"+Ve(i)+"'>"+n.innerHTML+"</a> "),(s=w("qunit-banner"))&&(s.className=""),C=w("qunit-tests"),(N=w("qunit-testresult"))&&N.parentNode.removeChild(N),C&&(C.innerHTML="",(N=y.createElement("p")).id="qunit-testresult",N.className="result",C.parentNode.insertBefore(N,C),N.innerHTML='<div id="qunit-testresult-display">Running...<br />&#160;</div><div id="qunit-testresult-controls"></div><div class="clearfix"></div>',h=w("qunit-testresult-controls")),h&&h.appendChild(((m=y.createElement("button")).id="qunit-abort-tests-button",m.innerHTML="Abort",l(m,"click",x),m)),(o=w("qunit-userAgent"))&&(o.innerHTML="",o.appendChild(y.createTextNode("QUnit "+Fe.version+"; "+k.userAgent))),(a=w("qunit-testrunner-toolbar"))&&(a.appendChild(((f=y.createElement("span")).innerHTML=function(){var t,n,i,s,o,a=!1,u=e.urlConfig,l=""
for(t=0;t<u.length;t++)if("string"==typeof(i=e.urlConfig[t])&&(i={id:i,label:i}),s=Ve(i.id),o=Ve(i.tooltip),i.value&&"string"!=typeof i.value){if(l+="<label for='qunit-urlconfig-"+s+"' title='"+o+"'>"+i.label+": </label><select id='qunit-urlconfig-"+s+"' name='"+s+"' title='"+o+"'><option></option>",Fe.is("array",i.value))for(n=0;n<i.value.length;n++)l+="<option value='"+(s=Ve(i.value[n]))+"'"+(e[i.id]===i.value[n]?(a=!0)&&" selected='selected'":"")+">"+s+"</option>"
else for(n in i.value)r.call(i.value,n)&&(l+="<option value='"+Ve(n)+"'"+(e[i.id]===n?(a=!0)&&" selected='selected'":"")+">"+Ve(i.value[n])+"</option>")
e[i.id]&&!a&&(l+="<option value='"+(s=Ve(e[i.id]))+"' selected='selected' disabled='disabled'>"+s+"</option>"),l+="</select>"}else l+="<label for='qunit-urlconfig-"+s+"' title='"+o+"'><input id='qunit-urlconfig-"+s+"' name='"+s+"' type='checkbox'"+(i.value?" value='"+Ve(i.value)+"'":"")+(e[i.id]?" checked='checked'":"")+" title='"+o+"' />"+Ve(i.label)+"</label>"
...
t.style.display=n.style.display=k?"":"none",o.placeholder=u.join(", ")||g.parentNode.textContent,o.title="Type to filter list. Current selection:\n"+(u.join("\n")||g.parentNode.textContent)}return o.id="qunit-modulefilter-search",o.autocomplete="off",l(o,"input",x),l(o,"input",w),l(o,"focus",w),l(o,"click",w),e.modules.forEach((function(e){return e.namePrepared=We.prepare(e.name)})),s.id="qunit-modulefilter-search-container",s.innerHTML="Module: ",s.appendChild(o),f.textContent="Apply",f.style.display="none",d.textContent="Reset",d.type="reset",d.style.display="none",g.type="checkbox",g.checked=0===e.moduleId.length,h.className="clickable",e.moduleId.length&&(h.className="checked"),h.appendChild(g),h.appendChild(y.createTextNode("All modules")),u.id="qunit-modulefilter-actions",u.appendChild(f),u.appendChild(d),u.appendChild(h),t=u.firstChild,n=t.nextSibling,l(t,"click",S),m.id="qunit-modulefilter-dropdown-list",m.innerHTML=j(e.modules),a.id="qunit-modulefilter-dropdown",a.style.display="none",a.appendChild(u),a.appendChild(m),l(a,"change",E),E(),i.id="qunit-modulefilter",i.appendChild(s),i.appendChild(a),l(i,"submit",T),l(i,"reset",(function(){p.setTimeout(E)})),i}()),s}()),a.appendChild(y.createElement("div")).className="clearfix")})),Fe.done((function(t){var n,r,i,s=w("qunit-banner"),o=w("qunit-tests"),a=w("qunit-abort-tests-button"),u=[Je.passedTests+Je.skippedTests+Je.todoTests+Je.failedTests," tests completed in ",t.runtime," milliseconds, with ",Je.failedTests," failed, ",Je.skippedTests," skipped, and ",Je.todoTests," todo.<br />","<span class='passed'>",t.passed,"</span> assertions of <span class='total'>",t.total,"</span> passed, <span class='failed'>",t.failed,"</span> failed."].join("")
if(a&&a.disabled){u="Tests aborted after "+t.runtime+" milliseconds."
for(var l=0;l<o.children.length;l++)""!==(n=o.children[l]).className&&"running"!==n.className||(n.className="aborted",i=n.getElementsByTagName("ol")[0],(r=y.createElement("li")).className="fail",r.innerHTML="Test aborted.",i.appendChild(r))}!s||a&&!1!==a.disabled||(s.className=Je.failedTests?"qunit-fail":"qunit-pass"),a&&a.parentNode.removeChild(a),o&&(w("qunit-testresult-display").innerHTML=u),e.altertitle&&y.title&&(y.title=[Je.failedTests?"✖":"✔",y.title.replace(/^[\u2714\u2716] /i,"")].join(" ")),e.scrolltop&&p.scrollTo&&p.scrollTo(0,0)})),Fe.testStart((function(t){var n,r,i,s,o,a,u,l,c,f
i=t.name,s=t.testId,o=t.module,(f=w("qunit-tests"))&&((a=y.createElement("strong")).innerHTML=q(i,o),(u=y.createElement("a")).innerHTML="Rerun",u.href=N({testId:s}),(l=y.createElement("li")).appendChild(a),l.appendChild(u),l.id="qunit-test-output-"+s,(c=y.createElement("ol")).className="qunit-assert-list",l.appendChild(c),f.appendChild(l)),(n=w("qunit-testresult-display"))&&(g(n,"running"),r=Fe.config.reorder&&t.previousFailure,n.innerHTML=[r?"Rerunning previously failed test: <br />":"Running: <br />",q(t.name,t.module),M(C()-e.started,Je,ue.count)].join(""))})),Fe.log((function(e){var t,n,i,s,o,a,u=!1,l=w("qunit-test-output-"+e.testId)
l&&(i="<span class='test-message'>"+(i=Ve(e.message)||(e.result?"okay":"failed"))+"</span>",i+="<span class='runtime'>@ "+e.runtime+" ms</span>",!e.result&&r.call(e,"expected")?(s=e.negative?"NOT "+Fe.dump.parse(e.expected):Fe.dump.parse(e.expected),o=Fe.dump.parse(e.actual),i+="<table><tr class='test-expected'><th>Expected: </th><td><pre>"+Ve(s)+"</pre></td></tr>",o!==s?(i+="<tr class='test-actual'><th>Result: </th><td><pre>"+Ve(o)+"</pre></td></tr>","number"==typeof e.actual&&"number"==typeof e.expected?isNaN(e.actual)||isNaN(e.expected)||(u=!0,a=((a=e.actual-e.expected)>0?"+":"")+a):"boolean"!=typeof e.actual&&"boolean"!=typeof e.expected&&(u=_(a=Fe.diff(s,o)).length!==_(s).length+_(o).length),u&&(i+="<tr class='test-diff'><th>Diff: </th><td><pre>"+a+"</pre></td></tr>")):-1!==s.indexOf("[object Array]")||-1!==s.indexOf("[object Object]")?i+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the depth of object is more than current max depth ("+Fe.config.maxDepth+").<p>Hint: Use <code>QUnit.dump.maxDepth</code> to  run with a higher max depth or <a href='"+Ve(N({maxDepth:-1}))+"'>Rerun</a> without max depth.</p></td></tr>":i+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the expected and actual results have an equivalent serialization</td></tr>",e.source&&(i+="<tr class='test-source'><th>Source: </th><td><pre>"+Ve(e.source)+"</pre></td></tr>"),i+="</table>"):!e.result&&e.source&&(i+="<table><tr class='test-source'><th>Source: </th><td><pre>"+Ve(e.source)+"</pre></td></tr></table>"),t=l.getElementsByTagName("ol")[0],(n=y.createElement("li")).className=e.result?"pass":"fail",n.innerHTML=i,t.appendChild(n))})),Fe.testDone((function(r){var i,s,o,a,u,c,f,d,h,p=w("qunit-tests"),m=w("qunit-test-output-"+r.testId)
...
if(r="selectedIndex"in s?s.options[s.selectedIndex].value||void 0:s.checked?s.defaultValue||!0:void 0,o[s.name]=r,n=N(o),"hidepassed"===s.name&&"replaceState"in p.history){if(Fe.urlParams[s.name]=r,e[s.name]=r||!1,i=w("qunit-tests")){var a=i.children.length,u=i.children
...
for(t in e=I(I({},Fe.urlParams),e))if(r.call(e,t)&&void 0!==e[t])for(n=[].concat(e[t]),i=0;i<n.length;i++)s+=encodeURIComponent(t),!0!==n[i]&&(s+="="+encodeURIComponent(n[i])),s+="&"
...
for(n=0;n<t.length;n++)""!==t[n].name&&(i+="<li><label class='clickable"+((r=e.moduleId.indexOf(t[n].moduleId)>-1)?" checked":"")+"'><input type='checkbox' value='"+t[n].moduleId+"'"+(r?" checked='checked'":"")+" />"+Ve(t[n].name)+"</label></li>")
return i}function q(e,t){var n=""
return t&&(n="<span class='module-name'>"+Ve(t)+"</span>: "),n+"<span class='test-name'>"+Ve(e)+"</span>"}function M(e,t,n){return["<br />",t.passedTests+t.skippedTests+t.todoTests+t.failedTests," / ",n," tests completed in ",e," milliseconds, with ",t.failedTests," failed, ",t.skippedTests," skipped, and ",t.todoTests," todo."].join("")}function _(e){return e.replace(/<\/?[^>]+(>|$)/g,"").replace(/&quot;/g,"").replace(/\s+/g,"")}}(),Fe.diff=function(){function e(){}var t=-1,n=Object.prototype.hasOwnProperty
...
for(i=0;i<e.length;i++)switch(n=e[i][0],r=e[i][1],n){case 1:s[i]="<ins>"+Ve(r)+"</ins>"
break
case t:s[i]="<del>"+Ve(r)+"</del>"
break
case 0:s[i]="<span>"+Ve(r)+"</span>"}return s.join("")},e.prototype.diffCommonPrefix=function(e,t){var n,r,i,s
