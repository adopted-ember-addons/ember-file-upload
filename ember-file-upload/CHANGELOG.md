...
#### :rocket: Enhancement
* `ember-file-upload`
  * [#1136](https://github.com/adopted-ember-addons/ember-file-upload/pull/1136) Replace RSVP functions with native Promise where possible ([@gilest](https://github.com/gilest))
